...
class TicketPage5 extends StatefulWidget {
  TicketPage5({Key key}) : super(key: key);

  @override
  _TicketPage5State createState() => _TicketPage5State();
}

class _TicketPage5State extends State<TicketPage5> {
  @override
    ...
    return StreamBuilder<MovieResponse>(
      ...
      builder: (context, AsyncSnapshot<MovieResponse> snapshot){
        if(snapshot.hasData){
          ...
          return _buildTicketPage5(snapshot.data);
