          ...
          children: <Widget>[
            Row(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),color: Style.Colors.mainColor.withOpacity(0.6),
                boxShadow: [BoxShadow(
                color: Style.Colors.emphasisBlack.withOpacity(0.6),
                spreadRadius: 5,
                blurRadius: 30,
            ...
            FlatButton(onPressed: (){},
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),color: Style.Colors.emphasisYellow.withOpacity(0.6),
                boxShadow: [BoxShadow(
                color: Style.Colors.emphasisBlack.withOpacity(0.6),
                spreadRadius: 5,
                blurRadius: 30,
            ...
            Row(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(18),color: Style.Colors.emphasisRed,
                boxShadow: [BoxShadow(
                color: Style.Colors.emphasisBlack.withOpacity(0.6),
                spreadRadius: 5,
                blurRadius: 30,
